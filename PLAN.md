# AI Compliance and Document Reviewer — Build Plan
...
Pipeline-oriented services: Next.js review UI; Hono API; Go document processor; Gemini RAG adapter; PostgreSQL/Prisma; MongoDB for parsed document structure; vector-capable PostgreSQL.
...
Next.js, TypeScript, shadcn/ui, Redux Toolkit, Hono, Go, Prisma, PostgreSQL/pgvector, MongoDB, Gemini API, object storage, Docker

## Core domain

Organization, Matter, Document, DocumentVersion, Chunk, Framework, Control, Finding, Citation, Review, Comment, Report, AuditEvent.

## API strategy

GraphQL for review workspace; REST for upload/export; SSE for pipeline progress; structured Gemini JSON responses.
